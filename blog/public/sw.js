...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-6dde97","is-html-6dde97","is-jsdelivr-6dde97","is-gtm-6dde97","is-gravatar-6dde97","is-theme-6dde97","is-cdn-6dde97","is-json-6dde97"];
      return Promise.all(
        names
