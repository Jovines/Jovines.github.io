...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-667238","is-html-667238","is-jsdelivr-667238","is-gtm-667238","is-gravatar-667238","is-theme-667238","is-cdn-667238","is-json-667238"];
      return Promise.all(
        names
