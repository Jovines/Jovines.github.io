...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-4316fd","is-html-4316fd","is-jsdelivr-4316fd","is-gtm-4316fd","is-gravatar-4316fd","is-theme-4316fd","is-cdn-4316fd","is-json-4316fd"];
      return Promise.all(
        names
