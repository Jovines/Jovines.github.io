...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ec6d99","is-html-ec6d99","is-jsdelivr-ec6d99","is-gtm-ec6d99","is-gravatar-ec6d99","is-theme-ec6d99","is-cdn-ec6d99","is-json-ec6d99"];
      return Promise.all(
        names
