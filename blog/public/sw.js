...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-de3dcf","is-html-de3dcf","is-jsdelivr-de3dcf","is-gtm-de3dcf","is-gravatar-de3dcf","is-theme-de3dcf","is-cdn-de3dcf","is-json-de3dcf"];
      return Promise.all(
        names
