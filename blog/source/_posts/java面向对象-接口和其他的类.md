...
- #### 听听抽象类的自白
  ...
  **（抽象类独白）**：
  ...
  ​		天生就是用来被别人来继承的，简而言之，只有当爸爸的命，从不当儿子。还有，别叫我去做事，我尊贵。

- #### ”只当爸爸“

  意味着它不可以被继承，大部分抽象类都是没有完整实现类功能的类，等待子类继承去实现，所以它是不可以被实例化成对像的。
  
  例子：<img src="java面向对象-接口和其他的类/9150e4e5gy1g19qh568dmj206o06ogll.jpg" alt="img" style="zoom: 50%;" />
