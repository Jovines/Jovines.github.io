...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-c1de7b","is-html-c1de7b","is-jsdelivr-c1de7b","is-gtm-c1de7b","is-gravatar-c1de7b","is-theme-c1de7b","is-cdn-c1de7b","is-json-c1de7b"];
      return Promise.all(
        names
