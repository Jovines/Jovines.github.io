...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-4ab304","is-html-4ab304","is-jsdelivr-4ab304","is-gtm-4ab304","is-gravatar-4ab304","is-theme-4ab304","is-cdn-4ab304","is-json-4ab304"];
      return Promise.all(
        names
