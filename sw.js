...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-dce0a5","is-html-dce0a5","is-jsdelivr-dce0a5","is-gtm-dce0a5","is-gravatar-dce0a5","is-theme-dce0a5","is-cdn-dce0a5","is-json-dce0a5"];
      return Promise.all(
        names
