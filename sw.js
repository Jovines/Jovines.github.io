...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-6878a1","is-html-6878a1","is-jsdelivr-6878a1","is-gtm-6878a1","is-gravatar-6878a1","is-theme-6878a1","is-cdn-6878a1","is-json-6878a1"];
      return Promise.all(
        names
